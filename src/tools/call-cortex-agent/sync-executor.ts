...
export async function executeSync(
  ...
  try {
    ...
    log(`[call_cortex_agent] Sending prompt to session ${sessionID}`)
    log(`[call_cortex_agent] Prompt text:`, args.prompt.substring(0, 100))
    ...
    try {
      ...
      log(`[call_cortex_agent] Prompt error:`, errorMessage)
