 ...
 * Instructs the plan agent to first gather context via tracker/researcher agents,
...
1. Launch background agents to gather context:
   - call_cortex_agent(description="Tracker codebase patterns", subagent_type="tracker", run_in_background=true, prompt="<search for relevant patterns, files, and implementations in the codebase related to user's request>")
   - call_cortex_agent(description="Research documentation", subagent_type="researcher", run_in_background=true, prompt="<search for external documentation, examples, and best practices related to user's request>")
...
#   BY CRITIC REVIEW. DO NOT SKIP. DO NOT ABBREVIATE.               #
#                                                                   #
#####################################################################
</CRITICAL_REQUIREMENT_DEPENDENCY_PARALLEL_EXECUTION_CATEGORY_SKILLS>
