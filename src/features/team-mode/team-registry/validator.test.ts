...
describe("team-registry validator", () => {
  ...
  test("rejects planner subagent members with the exact plan message", () => {
    // given
    const member: Member = {
      kind: "subagent_type",
      name: "planner",
  ...
  test("accepts founder subagent members after the D-36 eligibility change", () => {
    // given
    const member: Member = {
      kind: "subagent_type",
      name: "craftsman",
