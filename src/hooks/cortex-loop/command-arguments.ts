export type CortexLoopStrategy = "reset" | "continue"

export type ParsedCortexLoopArguments = {
  prompt: string
  maxIterations?: number
  completionPromise?: string
  strategy?: CortexLoopStrategy
}

const DEFAULT_PROMPT = "Complete the task as instructed"

export function parseCortexLoopArguments(rawArguments: string): ParsedCortexLoopArguments {
