...
import { isThinkerVerified } from "./thinker-verification-detector"
...
function shouldInspectSessionMessagePart(
	...
	return promise === DEEPWORK_VERIFICATION_PROMISE && isThinkerVerified(partText)
}
...
function shouldInspectTranscriptEntry(
	...
	return promise === DEEPWORK_VERIFICATION_PROMISE && isThinkerVerified(entryText)
}
