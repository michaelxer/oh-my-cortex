...
export function readState(directory: string, customPath?: string): CortexLoopState | null {
  ...
  try {
    ...
    const deepwork = data.deepwork === true || data.deepwork === "true" ? true : undefined
    const maxIterations =
...
export function writeState(
  ...
  try {
    ...
    const deepworkLine = state.deepwork !== undefined ? `deepwork: ${state.deepwork}\n` : ""
...
${sessionIdLine}${deepworkLine}${verificationPendingLine}${strategyLine}${messageCountAtStartLine}---
${state.prompt}
`
