/**
 * Gemini-optimized deepwork message.
 *
...
export const DEEPWORK_GEMINI_MESSAGE = `<deepwork-mode>
...
export function getGeminiDeepworkMessage(): string {
  return DEEPWORK_GEMINI_MESSAGE
}
