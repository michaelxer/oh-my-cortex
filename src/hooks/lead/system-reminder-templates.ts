...
You just performed direct file modifications outside \`.cortex/\`.
...
You should NOT:
- Write code directly (except for \`.cortex/\` files like plans and notepads)
- Make direct file edits outside \`.cortex/\`
...
export const WORKSTATE_CONTINUATION_PROMPT = `${createSystemDirective(SystemDirectiveTypes.WORKSTATE_CONTINUATION)}
...
- Use the notepad at .cortex/notepads/{PLAN_NAME}/ to record learnings
...
You (Lead) are attempting to directly modify a file outside \`.cortex/\`.
...
- Files inside \`.cortex/\` (plans, notepads, drafts)
- Reading files for verification
- Running diagnostics/tests

**FORBIDDEN direct file operations:**
- Writing/editing source code
- Creating new files outside \`.cortex/\`
...
**REMEMBER:** Planner already decomposed the work. Execute what you receive.
`
