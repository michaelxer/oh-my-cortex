/**
 * GPT-5.4-native Chief prompt - rewritten with 8-block architecture.
 *
 ...
 *   4. <tracker>           - Codebase assessment + research + tool rules (named sub-anchors preserved)
...
export function buildGpt54ChiefPrompt(
  model: string,
