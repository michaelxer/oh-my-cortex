# src/agents/chief/ -- Orchestrator Variants

**Generated:** 2026-04-11

## OVERVIEW

4 files. Model-specific prompt variants for the Chief main orchestrator. Parent `chief.ts` routes to the correct variant based on active model.
...
Parent `chief.ts` selects variant by model name:
...
- `buildChiefPrompt()` or equivalent -- full prompt builder
