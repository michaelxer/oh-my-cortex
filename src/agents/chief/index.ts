/**
 * Chief agent - multi-model orchestrator.
 *
...
export { buildDefaultChiefPrompt, buildTaskManagementSection } from "./default";
export { buildClaudeOpus47ChiefPrompt } from "./claude-opus-4-7";
export {
...
export { buildGpt54ChiefPrompt } from "./gpt-5-4";
export { buildGpt55ChiefPrompt } from "./gpt-5-5";
export { buildKimiK26ChiefPrompt } from "./kimi-k2-6";
