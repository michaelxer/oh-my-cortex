/**
 * Gemini-specific overlay sections for Chief prompt.
 *
 ...
 * in the dynamic Chief prompt to counter these tendencies.
 */
...
| \`Task\` | ANY non-trivial implementation. Research via tracker/researcher. | ✅ Fire multiple in background |
