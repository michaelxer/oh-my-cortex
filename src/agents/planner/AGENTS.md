# src/agents/planner/ -- Strategic Planner

**Generated:** 2026-04-11

## OVERVIEW

11 files. Planner agent -- interview-mode strategic planner. Reads codebase, questions user, builds detailed work plan before any code is written. Markdown-only output (enforced by `planner-md-only` hook).
...
- Must tracker codebase before planning (NEVER plan blind)
- Plans saved to `.cortex/plans/`
